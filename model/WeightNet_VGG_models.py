...
class WeightNet_VGG(nn.Module):
    def __init__(self, channel=32):
        super(WeightNet_VGG, self).__init__()
        #Backbone model
        self.vgg = VGG('rgb')
    ...
    def forward(self, x_rgb):
        ...
        x1_1 = self.vgg.conv1(x_rgb)
        x2_1 = self.vgg.conv2(x1_1)
        x3_1 = self.vgg.conv3(x2_1)
        x4_1 = self.vgg.conv4(x3_1)
        x5_1 = self.vgg.conv5(x4_1)
        
        s1_lbp, s2_lbp, s3_lbp, s4_lbp, s5_lbp, x1_sig, x2_sig, x3_sig, x4_sig, x5_sig = self.decoder_1(x5_1, x4_1, x3_1, x2_1, x1_1)  
